      ...
      setTimeout(() => {
        ...
        if (perfData && window.gtag) {
          ...
          window.gtag('event', 'page_performance', {
            ...
            dom_content_loaded_time: Math.round(perfData.domContentLoadedEventEnd - perfData.navigationStart),
            first_paint_time: Math.round(perfData.responseEnd - perfData.navigationStart)
          })
        }
      }, 0)
    })
